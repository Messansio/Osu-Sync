...
OsuPathUtility::OsuPathUtility(const bool isSyncing, std::pair<bool,bool> whatClient, std::queue<std::string> &stringQueue, std::mutex &mutex, std::condition_variable &queueCV) 
